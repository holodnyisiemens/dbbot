...
class BotClient:
    ...
    def find_hash(
        ...
        '''
        Функция, вычисляющая хэш-сумму пароля 
        HASHES_NUMBER раз с применением солей
        '''
        hash: str = password
    ...
    def insert_in_table(self, user: User):
        '''
    ...
    def user_exists(
        ...
        with Session() as sess:
            ...
            # иначе None.
            result = sess.query(Users_table.login) \
                         .filter(Users_table.login == login) \
                         .one_or_none()
    ...
    def check_pass(
        ...
        with Session() as sess:
            ...
            result = sess.query(Users_table.passhash) \
                         .filter(Users_table.login == login) \
                         .one()
